...
public class Settings {
    ...
    private final static String HUE_LOW = "hue_low";
    private final static String SAT_LOW = "sat_low";
    private final static String VAL_LOW = "val_low";
    private final static String HUE_HIGH = "hue_high";
    private final static String SAT_HIGH = "sat_high";
    private final static String VAL_HIGH = "val_high";
